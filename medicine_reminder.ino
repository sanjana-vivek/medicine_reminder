...
int buzz8amHH = 22;          //    HH - hours         ##Set these for reminder time in 24hr Format 

int buzz8amMM = 46;          //    MM - Minute

int buzz8amSS = 00;          //    SS - Seconds


int buzz2pmHH = 22;          //    HH - hours

int buzz2pmMM = 48;          //    MM - Minute

int buzz2pmSS = 00;          //    SS - Seconds


int buzz8pmHH = 22;          //    HH - hours

int buzz8pmMM = 50;          //    MM - Minute
